...
<head>
    ...
    <title>Marcella Hadderingh</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <div class="col-12" data-aos="flip-right">
        ...
        <br>
        <h2><i class="fas fa-user"></i>Personalia</h2>
        <ul class="personalia ">
            <li><strong>NAAM</strong></li>
            <li>Marcella Hadderingh</li>
            <li><strong>GEBOORTEDATUM</strong></li>
            <li>19 September 1988</li>
            <li><strong>GEBOORTEPLAATS</strong></li>
            <li>Enschede</li>
    ...
    <div class="col-12" data-aos="flip-left">
        <div id="space">
            ...
            <h2>Traject</h2>
            <p><strong>2014</strong> Voorschakel traject (VCA behaald) Cursus
            </p>
            <p><strong>2011</strong> KNVB Steward Certificaat behaald</p>
        </div>
    </div>
    <div class="col-12" data-aos="flip-right">
        <div id="space">
            ...
            <ul>
                ...
                <li><strong>2004-2007</strong><br> Verschillende banen op de Markt,<br> Verschillende branche<br>
    ...
    <div id="section3" class="container-fluid " style="padding-top:70px;padding-bottom:70px ">
        <img src="foto/Portfolio2.jpg" alt="portfoliop" width="100%" data-aos="zoom-in-up">
        <div class="row">
            <div class="col-10">
                <div id="hackaton">
            ...
            <div class="container">
                <div class="row">
                    <div class="col " data-aos="fade-up-right">
                        <h3>Week 1</h3>
                        <p> Week 1 hebben ik veel met HTML + CSS gewerkt. Hier voor heb ik een checlist en een leerplan
                            gemaakt. En ook mijn CV versie 1 heb ik hierin gemaakt. Mijn Leerplan versie 1 en CV versie
                            1 zijn hier in te zien.</p>
                    ...
                    <div class="col" data-aos="fade-up-left">
                        <h3>Week 2</h3>
                        <p>Hierin ben ik bezig gegaan met Javascript en Bootstrap. Mijn CV Portfolio versie 2 is
                    ...
                    <div class="col" data-aos="fade-up-left" style="margin-top:280px">
                        <h3>Week 4</h3>
                        <p>In week 4 zijn wij begonnen met PHP. Ik heb mijn contact formulier met PHP gemaakt. Als je
                            deze verzend krijg ik hier een email van. Helaas werkt dit nog niet met Heroku. Ik ben hier
                            nog mee bezig.</p>
                    ...
                    <div class="col" data-oas="fade-up-right" style="margin-top:40px">
                        <h4>Week 5</h4>
                        <p>Hier ben ik verder gegaan met PHP.Ook ben ik begonnen met MySql, en heb ik een database
                            aangemaakt.</p>
                    </div>
            ...
            <div class='row'>
                ...
                <div class="check">
                    <ul>
                        <h1>Programs</h1>
                        <li>
                            <h3><i id="check" class="fas fa-check-circle"></i> HTML</h3>
                        </li>
                        <li>
                            <h3><i id="check" class="fas fa-check-circle"></i> CSS</h3>
                        </li>
                        <li>
                            <h3><i id="check" class="fas fa-check-circle"></i> Javascipt</h3>
                        </li>
                        <li>
                            <h3><i id="check" class="fas fa-check-circle"></i> PHP</h3>
                        </li>
                        <li>
                            <h3><i id="check" class="fas fa-check-circle"></i> Bootstrap</h3>
                        </li>
                        <li>
                            <h3><i id="check" class="fas fa-check-circle"></i> Git</h3>
                        </li>
                        <li>
                            <h3><i id="check" class="fas fa-check-circle"></i> VSCode</h3>
                        </li>
                        <li>
                            <h3><i id="check" class="fas fa-check-circle"></i> SQL</h3>
                        </li>
                        <li>
                            <h3><i id="check" class="fas fa-check-circle"></i> Scrum</h3>
                        </li>
                        <li>
